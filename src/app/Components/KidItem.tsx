  ...
  const handleClick = () => {
    ...
    return (
        <div className="relative w-72 mx-auto p-2">
            ...
            <div
                className={`relative z-20 w-55 h-55 bg-white shadow-2xl rounded-4xl mx-auto my-4 p-4 cursor-pointer transition-all duration-300 ${isPurchased ? 'opacity-50 pointer-events-none' : 'hover:scale-105'
                    }`}
                onClick={handleClick}
            >
