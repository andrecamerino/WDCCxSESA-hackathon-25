...
const Notification: React.FC<NotificationProps> = ({ type, person, item }) => {
  ...
  return (
    <a
      href={href}
      className="w-auto bg-white h-[80px] rounded-4xl grid grid-cols-[70px_1fr] items-center mx-2 px-4 text-xl shadow-[6px_6px_0px_rgba(0,0,0,0.2)] border-6 border-black"
    >
