...
import MCQQuestion from "./MCQquestions";
...
const Questions: React.FC = () => {
  ...
  return (
    <div className="w-[600px] mt-10 justify-center items-center">
      ...
      <button
        ...
        className="mt-4 px-4 py-2 bg-blue-500 text-white rounded disabled:opacity-50 hover:bg-blue-600"
      >
        Submit
      </button>
    </div>
